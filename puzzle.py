...
more information: https://d2l.ai/chapter_convolutional-neuralnetworks/padding-and-strides.html
...
def image_smoother(
    ...
    """Optimize an input image.

    :param input_image: np.ndarray, input image.
    :param kernel_height: Int, height of the local neighborhood of each image pixel.
    :param kernel_width: Int, width of the local neighborhood of each image pixel.
    :param stride_height: Int, height of the local neighborhood's stride.
    :param stride_width: Int, width of the local neighborhood's stride.
    """
